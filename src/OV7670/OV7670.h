...
class OV7670: public I2SCamera {
    ...
    public:
        OV7670(OV7670::Mode m, int SIOD, int SIOC, int VSYNC, int HREF, int XCLK, int PCLK, int D0, int D1, int D2, int D3, int D4, int D5, int D6, int D7);
    ...
    static const int COM8_AECSTEP = 0x40;
    static const int COM8_BFILT = 0x20;
    static const int COM8_AGC = 0x04;
    static const int COM8_AWB = 0x02;
